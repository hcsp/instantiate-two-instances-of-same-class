...
请在[Home](https://github.com/hcsp/instantiate-two-instances-of-same-class/blob/master/src/main/java/com/github/hcsp/Home.java)中创建指定类的多个对象并修改其成员。在提交Pull Request之前，你应当在本地确保所有代码已经编译通过，并且通过了测试(`mvn clean verify`)
